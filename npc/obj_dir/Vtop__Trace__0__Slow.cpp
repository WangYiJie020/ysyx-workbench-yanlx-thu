...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+33,"npc_wbu_to_ifu", false,-1, 31,0);
    tracep->declBit(c+34,"valid_wbu_to_ifu", false,-1);
    ...
    tracep->declBit(c+35,"ready_idu_to_exu", false,-1);
    ...
    tracep->declBus(c+39,"alu_result_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+40,"rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+41,"rs2_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+42,"csr_rdata_l_rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+43,"npc_exu_to_lsu", false,-1, 31,0);
    tracep->declBit(c+44,"MemRead_exu_to_lsu", false,-1);
    tracep->declBit(c+45,"MemWrite_exu_to_lsu", false,-1);
    tracep->declBus(c+46,"wmask_exu_to_lsu", false,-1, 7,0);
    tracep->declBus(c+47,"rmask_exu_to_lsu", false,-1, 2,0);
    tracep->declBit(c+48,"wb_src_exu_to_lsu", false,-1);
    tracep->declBit(c+49,"csr_write_exu_to_lsu", false,-1);
    tracep->declBit(c+50,"csr_wdta_src_exu_to_lsu", false,-1);
    tracep->declBit(c+51,"reg_write_exu_to_lsu", false,-1);
    tracep->declBus(c+52,"waddr_exu_to_lsu", false,-1, 4,0);
    tracep->declBit(c+53,"valid_exu_to_lsu", false,-1);
    tracep->declBit(c+54,"ready_exu_to_lsu", false,-1);
    tracep->declBus(c+55,"alu_result_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+56,"rs1_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+57,"csr_rdata_l_rs1_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+58,"datamem_readdata_lsu_to_wbu", false,-1, 31,0);
    ...
    tracep->declBus(c+55,"lsu_araddr", false,-1, 31,0);
    ...
    tracep->declBus(c+55,"lsu_awaddr", false,-1, 31,0);
    ...
    tracep->declBus(c+55,"awaddr_i", false,-1, 31,0);
    ...
    tracep->declBit(c+19,"aw_state", false,-1);
    ...
    tracep->declBit(c+35,"exu_ready_o", false,-1);
    tracep->declBus(c+39,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+40,"rs1_o", false,-1, 31,0);
    tracep->declBus(c+41,"rs2_o", false,-1, 31,0);
    tracep->declBus(c+42,"csr_rdata_l_rs1_o", false,-1, 31,0);
    tracep->declBus(c+43,"npc_o", false,-1, 31,0);
    tracep->declBit(c+44,"MemRead_o", false,-1);
    tracep->declBit(c+45,"MemWrite_o", false,-1);
    tracep->declBus(c+46,"wmask_o", false,-1, 7,0);
    tracep->declBus(c+47,"rmask_o", false,-1, 2,0);
    tracep->declBit(c+48,"wb_src_o", false,-1);
    tracep->declBit(c+49,"csr_write_o", false,-1);
    tracep->declBit(c+50,"csr_wdata_src_o", false,-1);
    tracep->declBit(c+51,"reg_write_o", false,-1);
    tracep->declBus(c+52,"waddr_o", false,-1, 4,0);
    tracep->declBit(c+53,"exu_valid_o", false,-1);
    tracep->declBit(c+54,"exu_ready_i", false,-1);
    ...
    tracep->declBit(c+35,"idu_ready_i", false,-1);
    ...
    tracep->declBus(c+274,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+275,"S_SEND", false,-1, 1,0);
    tracep->declBus(c+21,"current_state", false,-1, 1,0);
    ...
    tracep->declBit(c+34,"ifu_valid_i", false,-1);
    ...
    tracep->declBus(c+22,"current_state", false,-1, 2,0);
    ...
    tracep->declBit(c+27,"b_state", false,-1);
    tracep->declBus(c+28,"araddr", false,-1, 31,0);
    tracep->declBus(c+29,"awaddr", false,-1, 31,0);
    tracep->declBus(c+30,"wdata", false,-1, 31,0);
    tracep->declBus(c+31,"wstrb", false,-1, 7,0);
    tracep->declBit(c+287,"wvalid", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("LSU ");
    tracep->declBit(c+266,"clk", false,-1);
    tracep->declBit(c+267,"rst_n", false,-1);
    tracep->declBus(c+39,"alu_result_i", false,-1, 31,0);
    tracep->declBus(c+40,"rs1_i", false,-1, 31,0);
    tracep->declBus(c+41,"rs2_i", false,-1, 31,0);
    tracep->declBus(c+42,"csr_rdata_l_rs1_i", false,-1, 31,0);
    tracep->declBus(c+43,"npc_i", false,-1, 31,0);
    tracep->declBit(c+44,"MemRead_i", false,-1);
    tracep->declBit(c+45,"MemWrite_i", false,-1);
    tracep->declBus(c+46,"wmask_i", false,-1, 7,0);
    tracep->declBus(c+47,"rmask_i", false,-1, 2,0);
    tracep->declBit(c+48,"wb_src_i", false,-1);
    tracep->declBit(c+49,"csr_write_i", false,-1);
    tracep->declBit(c+50,"csr_wdata_src_i", false,-1);
    tracep->declBit(c+51,"reg_write_i", false,-1);
    tracep->declBus(c+52,"waddr_i", false,-1, 4,0);
    tracep->declBit(c+53,"lsu_valid_i", false,-1);
    tracep->declBit(c+54,"lsu_ready_o", false,-1);
    tracep->declBus(c+55,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+56,"rs1_o", false,-1, 31,0);
    tracep->declBus(c+57,"csr_rdata_l_rs1_o", false,-1, 31,0);
    tracep->declBus(c+58,"datamem_readdata_o", false,-1, 31,0);
    ...
    tracep->declBus(c+56,"rs1", false,-1, 31,0);
    ...
    tracep->declBit(c+32,"flag", false,-1);
    tracep->declBus(c+273,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+274,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+275,"S_SEND", false,-1, 1,0);
    ...
    tracep->declBit(c+266,"clk", false,-1);
    tracep->declBit(c+267,"rst_n", false,-1);
    tracep->declBus(c+55,"alu_result_i", false,-1, 31,0);
    tracep->declBus(c+56,"rs1_i", false,-1, 31,0);
    tracep->declBus(c+57,"csr_rdata_l_rs1_i", false,-1, 31,0);
    tracep->declBus(c+58,"datamem_readdata_i", false,-1, 31,0);
    ...
    tracep->declBit(c+34,"wbu_valid_o", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+18,(vlSelf->top__DOT__Data_Mem__DOT__ar_state));
    bufp->fullBit(oldp+19,(vlSelf->top__DOT__Data_Mem__DOT__aw_state));
    bufp->fullBit(oldp+20,(vlSelf->top__DOT__Data_Mem__DOT__b_state));
    bufp->fullCData(oldp+21,(vlSelf->top__DOT__IDU__DOT__current_state),2);
    bufp->fullCData(oldp+22,(vlSelf->top__DOT__IFU__DOT__current_state),3);
    bufp->fullBit(oldp+23,(vlSelf->top__DOT__Inst_Mem__DOT__ar_state));
    bufp->fullBit(oldp+24,(vlSelf->top__DOT__Inst_Mem__DOT__r_state));
    bufp->fullBit(oldp+25,(vlSelf->top__DOT__Inst_Mem__DOT__aw_state));
    bufp->fullBit(oldp+26,(vlSelf->top__DOT__Inst_Mem__DOT__w_state));
    bufp->fullBit(oldp+27,(vlSelf->top__DOT__Inst_Mem__DOT__b_state));
    bufp->fullIData(oldp+28,(vlSelf->top__DOT__Inst_Mem__DOT__araddr),32);
    bufp->fullIData(oldp+29,(vlSelf->top__DOT__Inst_Mem__DOT__awaddr),32);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__Inst_Mem__DOT__wdata),32);
    bufp->fullCData(oldp+31,(vlSelf->top__DOT__Inst_Mem__DOT__wstrb),8);
    bufp->fullBit(oldp+32,(vlSelf->top__DOT__LSU__DOT__flag));
    bufp->fullIData(oldp+33,(vlSelf->top__DOT__npc_wbu_to_ifu),32);
    bufp->fullBit(oldp+34,(vlSelf->top__DOT__valid_wbu_to_ifu));
    bufp->fullBit(oldp+35,(vlSelf->top__DOT__ready_idu_to_exu));
    ...
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__EXU__DOT__alu_result),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__EXU__DOT__rs1),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__EXU__DOT__rs2),32);
    bufp->fullIData(oldp+42,((vlSelf->top__DOT__EXU__DOT__csr_rdata 
                              | vlSelf->top__DOT__EXU__DOT__rs1)),32);
    bufp->fullIData(oldp+43,(((4U & (IData)(vlSelf->top__DOT__EXU__DOT__pc_srcs))
    ...
    bufp->fullBit(oldp+44,(vlSelf->top__DOT__MemRead_exu_to_lsu));
    bufp->fullBit(oldp+45,(vlSelf->top__DOT__MemWrite_exu_to_lsu));
    bufp->fullCData(oldp+46,(vlSelf->top__DOT__wmask_exu_to_lsu),8);
    bufp->fullCData(oldp+47,(vlSelf->top__DOT__rmask_exu_to_lsu),3);
    bufp->fullBit(oldp+48,(vlSelf->top__DOT__wb_src_exu_to_lsu));
    bufp->fullBit(oldp+49,(vlSelf->top__DOT__csr_write_exu_to_lsu));
    bufp->fullBit(oldp+50,(vlSelf->top__DOT__csr_wdta_src_exu_to_lsu));
    bufp->fullBit(oldp+51,(vlSelf->top__DOT__reg_write_exu_to_lsu));
    bufp->fullCData(oldp+52,(vlSelf->top__DOT__waddr_exu_to_lsu),5);
    bufp->fullBit(oldp+53,(vlSelf->top__DOT__valid_exu_to_lsu));
    bufp->fullBit(oldp+54,(vlSelf->top__DOT__ready_exu_to_lsu));
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__LSU__DOT__alu_result),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__LSU__DOT__rs1),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__csr_rdata_l_rs1_lsu_to_wbu),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__lsu_rdata),32);
