...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+203,"raddr1", false,-1, 4,0);
    tracep->declBus(c+204,"raddr2", false,-1, 4,0);
    tracep->declBus(c+232,"rdata1", false,-1, 31,0);
    tracep->declBus(c+233,"rdata2", false,-1, 31,0);
    tracep->declBus(c+90,"a5", false,-1, 31,0);
    tracep->declBus(c+205,"pc_idu_to_exu", false,-1, 31,0);
    tracep->declBus(c+232,"rs1_idu_to_exu", false,-1, 31,0);
    tracep->declBus(c+233,"rs2_idu_to_exu", false,-1, 31,0);
    tracep->declBus(c+206,"imm_idu_to_exu", false,-1, 31,0);
    tracep->declBus(c+234,"csr_rdata_idu_to_exu", false,-1, 31,0);
    tracep->declBit(c+207,"a_in_src_idu_to_exu", false,-1);
    tracep->declBus(c+208,"b_in_src_idu_to_exu", false,-1, 1,0);
    tracep->declBus(c+209,"pc_srcs_idu_to_exu", false,-1, 2,0);
    tracep->declBit(c+210,"adder_a_src_idu_to_exu", false,-1);
    tracep->declBit(c+211,"adder_out_src_idu_to_exu", false,-1);
    tracep->declBus(c+212,"alu_op_idu_to_exu", false,-1, 3,0);
    tracep->declBit(c+213,"MemRead_idu_to_exu", false,-1);
    tracep->declBit(c+214,"MemWrite_idu_to_exu", false,-1);
    tracep->declBus(c+215,"wmask_idu_to_exu", false,-1, 7,0);
    tracep->declBus(c+216,"rmask_idu_to_exu", false,-1, 2,0);
    tracep->declBit(c+217,"wb_src_idu_to_exu", false,-1);
    tracep->declBit(c+218,"csr_write_idu_to_exu", false,-1);
    tracep->declBit(c+219,"csr_wdata_src_idu_to_exu", false,-1);
    tracep->declBit(c+220,"reg_write_idu_to_exu", false,-1);
    tracep->declBus(c+221,"waddr_idu_to_exu", false,-1, 4,0);
    tracep->declBit(c+2,"valid_idu_to_exu", false,-1);
    tracep->declBit(c+9,"ready_idu_to_exu", false,-1);
    tracep->declBit(c+222,"csr_write", false,-1);
    tracep->declBus(c+223,"csr_wdata", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+95+i*1,"reg_file", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+235,"datamem_readdata_lsu_to_wbu", false,-1, 31,0);
    ...
    tracep->declBus(c+206,"imm_i", false,-1, 31,0);
    tracep->declBus(c+234,"csr_rdata_i", false,-1, 31,0);
    tracep->declBit(c+207,"a_in_src_i", false,-1);
    tracep->declBus(c+208,"b_in_src_i", false,-1, 1,0);
    tracep->declBus(c+209,"pc_srcs_i", false,-1, 2,0);
    tracep->declBit(c+210,"adder_a_src_i", false,-1);
    tracep->declBit(c+211,"adder_out_src_i", false,-1);
    tracep->declBus(c+212,"alu_op_i", false,-1, 3,0);
    tracep->declBit(c+213,"MemRead_i", false,-1);
    tracep->declBit(c+214,"MemWrite_i", false,-1);
    tracep->declBus(c+215,"wmask_i", false,-1, 7,0);
    tracep->declBus(c+216,"rmask_i", false,-1, 2,0);
    tracep->declBit(c+217,"wb_src_i", false,-1);
    tracep->declBit(c+218,"csr_write_i", false,-1);
    tracep->declBit(c+219,"csr_wdata_src_i", false,-1);
    tracep->declBit(c+220,"reg_write_i", false,-1);
    tracep->declBus(c+221,"waddr_i", false,-1, 4,0);
    ...
    tracep->declBus(c+206,"imm_o", false,-1, 31,0);
    tracep->declBus(c+234,"csr_rdata_o", false,-1, 31,0);
    tracep->declBit(c+207,"a_in_src_o", false,-1);
    tracep->declBus(c+208,"b_in_src_o", false,-1, 1,0);
    tracep->declBus(c+209,"pc_srcs_o", false,-1, 2,0);
    tracep->declBit(c+210,"adder_a_src_o", false,-1);
    tracep->declBit(c+211,"adder_out_src_o", false,-1);
    tracep->declBus(c+212,"alu_op", false,-1, 3,0);
    tracep->declBit(c+213,"MemRead_o", false,-1);
    tracep->declBit(c+214,"MemWrite_o", false,-1);
    tracep->declBus(c+215,"wmask_o", false,-1, 7,0);
    tracep->declBus(c+216,"rmask_o", false,-1, 2,0);
    tracep->declBit(c+217,"wb_src_o", false,-1);
    tracep->declBit(c+218,"csr_write_o", false,-1);
    tracep->declBit(c+219,"csr_wdata_src_o", false,-1);
    tracep->declBit(c+220,"reg_write_o", false,-1);
    tracep->declBus(c+221,"waddr_o", false,-1, 4,0);
    tracep->declBit(c+2,"idu_valid_o", false,-1);
    tracep->declBit(c+9,"idu_ready_i", false,-1);
    tracep->declBit(c+222,"csr_write_i", false,-1);
    tracep->declBus(c+223,"csr_wdata_i", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+90,"NO", false,-1, 31,0);
    tracep->declBus(c+205,"pc", false,-1, 31,0);
    ...
    tracep->declBus(c+224,"inst", false,-1, 31,0);
    tracep->declBit(c+207,"a_in_src", false,-1);
    tracep->declBus(c+208,"b_in_src", false,-1, 1,0);
    tracep->declBit(c+220,"reg_write", false,-1);
    tracep->declBus(c+209,"pc_srcs", false,-1, 2,0);
    tracep->declBit(c+210,"adder_a_src", false,-1);
    tracep->declBit(c+213,"MemRead", false,-1);
    tracep->declBit(c+214,"MemWrite", false,-1);
    tracep->declBus(c+215,"wmask", false,-1, 7,0);
    tracep->declBit(c+217,"wb_src", false,-1);
    tracep->declBus(c+216,"rmask", false,-1, 2,0);
    tracep->declBit(c+218,"csr_write", false,-1);
    tracep->declBit(c+211,"adder_out_src", false,-1);
    tracep->declBit(c+219,"csr_wdata_src", false,-1);
    tracep->declBus(c+225,"opcode", false,-1, 6,0);
    tracep->declBus(c+226,"funct3", false,-1, 2,0);
    tracep->declBus(c+227,"funct7", false,-1, 6,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+224,"inst", false,-1, 31,0);
    tracep->declBus(c+206,"data", false,-1, 31,0);
    tracep->declBus(c+225,"opcode", false,-1, 6,0);
    tracep->declBus(c+226,"funct3", false,-1, 2,0);
    tracep->declBus(c+227,"funct7", false,-1, 6,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+235,"datamem_readdata_o", false,-1, 31,0);
    ...
    tracep->declBus(c+235,"datamem_readdata", false,-1, 31,0);
    ...
    tracep->declBus(c+66,"wmask", false,-1, 7,0);
    tracep->declBus(c+33,"rmask", false,-1, 2,0);
    tracep->declBus(c+235,"read_data", false,-1, 31,0);
    tracep->declBus(c+69,"wmask_send", false,-1, 7,0);
    tracep->declBus(c+70,"rmask_send", false,-1, 7,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+204,"raddr2", false,-1, 4,0);
    tracep->declBus(c+233,"rdata2", false,-1, 31,0);
    tracep->declBus(c+90,"value1", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBus(c+235,"datamem_readdata_i", false,-1, 31,0);
    ...
    tracep->declBus(c+223,"csr_wdata_o", false,-1, 31,0);
    tracep->declBus(c+10,"wdata_o", false,-1, 31,0);
    tracep->declBit(c+222,"csr_write_o", false,-1);
    tracep->declBit(c+12,"reg_write_o", false,-1);
    tracep->declBus(c+11,"waddr_o", false,-1, 4,0);
    tracep->declBus(c+71,"mem_data", false,-1, 31,0);
    tracep->declBus(c+72,"datamem_readdata", false,-1, 31,0);
    tracep->declBus(c+73,"alu_result", false,-1, 31,0);
    tracep->declBus(c+74,"rs1", false,-1, 31,0);
    tracep->declBus(c+75,"csr_rdata_l_rs1", false,-1, 31,0);
    tracep->declBus(c+76,"rmask", false,-1, 2,0);
    tracep->declBit(c+77,"wb_src", false,-1);
    tracep->declBit(c+78,"csr_wdata_src", false,-1);
    tracep->declBus(c+236,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+237,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+238,"S_SEND", false,-1, 1,0);
    tracep->declBus(c+79,"current_state", false,-1, 1,0);
    ...
    tracep->declBus(c+81,"addr_low2", false,-1, 1,0);
    tracep->declBus(c+76,"rmask", false,-1, 2,0);
    tracep->declBus(c+71,"mem_data", false,-1, 31,0);
    tracep->declBus(c+82,"sbyte3", false,-1, 31,0);
    tracep->declBus(c+83,"sbyte2", false,-1, 31,0);
    tracep->declBus(c+84,"sbyte1", false,-1, 31,0);
    tracep->declBus(c+85,"sbyte0", false,-1, 31,0);
    tracep->declBus(c+86,"byte3", false,-1, 31,0);
    tracep->declBus(c+87,"byte2", false,-1, 31,0);
    tracep->declBus(c+88,"byte1", false,-1, 31,0);
    tracep->declBus(c+89,"byte0", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+70,(vlSelf->top__DOT__LSU__DOT__rmask),8);
    bufp->fullIData(oldp+71,(vlSelf->top__DOT__WBU__DOT__mem_data),32);
    bufp->fullIData(oldp+72,(vlSelf->top__DOT__WBU__DOT__datamem_readdata),32);
    bufp->fullIData(oldp+73,(vlSelf->top__DOT__WBU__DOT__alu_result),32);
    bufp->fullIData(oldp+74,(vlSelf->top__DOT__WBU__DOT__rs1),32);
    bufp->fullIData(oldp+75,(vlSelf->top__DOT__WBU__DOT__csr_rdata_l_rs1),32);
    bufp->fullCData(oldp+76,(vlSelf->top__DOT__WBU__DOT__rmask),3);
    bufp->fullBit(oldp+77,(vlSelf->top__DOT__WBU__DOT__wb_src));
    bufp->fullBit(oldp+78,(vlSelf->top__DOT__WBU__DOT__csr_wdata_src));
    bufp->fullCData(oldp+79,(vlSelf->top__DOT__WBU__DOT__current_state),2);
    bufp->fullCData(oldp+80,(vlSelf->top__DOT__WBU__DOT__next_state),2);
    bufp->fullCData(oldp+81,((3U & vlSelf->top__DOT__WBU__DOT__alu_result)),2);
    bufp->fullIData(oldp+82,((((- (IData)((vlSelf->top__DOT__WBU__DOT__datamem_readdata 
                                           >> 0x1fU))) 
    ...
    bufp->fullIData(oldp+86,((vlSelf->top__DOT__WBU__DOT__datamem_readdata 
                              >> 0x18U)),32);
    ...
    bufp->fullIData(oldp+88,((0xffU & (vlSelf->top__DOT__WBU__DOT__datamem_readdata 
                                       >> 8U))),32);
    bufp->fullIData(oldp+89,((0xffU & vlSelf->top__DOT__WBU__DOT__datamem_readdata)),32);
    bufp->fullIData(oldp+90,(vlSelf->top__DOT__Rgefile__DOT__rf
                             [0xfU]),32);
    bufp->fullIData(oldp+91,(vlSelf->top__DOT__csr_reg[0]),32);
    bufp->fullIData(oldp+92,(vlSelf->top__DOT__csr_reg[1]),32);
    bufp->fullIData(oldp+93,(vlSelf->top__DOT__csr_reg[2]),32);
    bufp->fullIData(oldp+94,(vlSelf->top__DOT__csr_reg[3]),32);
    bufp->fullIData(oldp+95,(vlSelf->top__DOT__reg_file[0]),32);
    bufp->fullIData(oldp+96,(vlSelf->top__DOT__reg_file[1]),32);
    bufp->fullIData(oldp+97,(vlSelf->top__DOT__reg_file[2]),32);
    bufp->fullIData(oldp+98,(vlSelf->top__DOT__reg_file[3]),32);
    bufp->fullIData(oldp+99,(vlSelf->top__DOT__reg_file[4]),32);
    bufp->fullIData(oldp+100,(vlSelf->top__DOT__reg_file[5]),32);
    bufp->fullIData(oldp+101,(vlSelf->top__DOT__reg_file[6]),32);
    bufp->fullIData(oldp+102,(vlSelf->top__DOT__reg_file[7]),32);
    bufp->fullIData(oldp+103,(vlSelf->top__DOT__reg_file[8]),32);
    bufp->fullIData(oldp+104,(vlSelf->top__DOT__reg_file[9]),32);
    bufp->fullIData(oldp+105,(vlSelf->top__DOT__reg_file[10]),32);
    bufp->fullIData(oldp+106,(vlSelf->top__DOT__reg_file[11]),32);
    bufp->fullIData(oldp+107,(vlSelf->top__DOT__reg_file[12]),32);
    bufp->fullIData(oldp+108,(vlSelf->top__DOT__reg_file[13]),32);
    bufp->fullIData(oldp+109,(vlSelf->top__DOT__reg_file[14]),32);
    bufp->fullIData(oldp+110,(vlSelf->top__DOT__reg_file[15]),32);
    bufp->fullIData(oldp+111,(vlSelf->top__DOT__reg_file[16]),32);
    bufp->fullIData(oldp+112,(vlSelf->top__DOT__reg_file[17]),32);
    bufp->fullIData(oldp+113,(vlSelf->top__DOT__reg_file[18]),32);
    bufp->fullIData(oldp+114,(vlSelf->top__DOT__reg_file[19]),32);
    bufp->fullIData(oldp+115,(vlSelf->top__DOT__reg_file[20]),32);
    bufp->fullIData(oldp+116,(vlSelf->top__DOT__reg_file[21]),32);
    bufp->fullIData(oldp+117,(vlSelf->top__DOT__reg_file[22]),32);
    bufp->fullIData(oldp+118,(vlSelf->top__DOT__reg_file[23]),32);
    bufp->fullIData(oldp+119,(vlSelf->top__DOT__reg_file[24]),32);
    bufp->fullIData(oldp+120,(vlSelf->top__DOT__reg_file[25]),32);
    bufp->fullIData(oldp+121,(vlSelf->top__DOT__reg_file[26]),32);
    bufp->fullIData(oldp+122,(vlSelf->top__DOT__reg_file[27]),32);
    bufp->fullIData(oldp+123,(vlSelf->top__DOT__reg_file[28]),32);
    bufp->fullIData(oldp+124,(vlSelf->top__DOT__reg_file[29]),32);
    bufp->fullIData(oldp+125,(vlSelf->top__DOT__reg_file[30]),32);
    bufp->fullIData(oldp+126,(vlSelf->top__DOT__reg_file[31]),32);
    bufp->fullIData(oldp+127,(vlSelf->top__DOT____Vcellout__IDU__csr_reg[0]),32);
    bufp->fullIData(oldp+128,(vlSelf->top__DOT____Vcellout__IDU__csr_reg[1]),32);
    bufp->fullIData(oldp+129,(vlSelf->top__DOT____Vcellout__IDU__csr_reg[2]),32);
    bufp->fullIData(oldp+130,(vlSelf->top__DOT____Vcellout__IDU__csr_reg[3]),32);
    bufp->fullIData(oldp+131,(vlSelf->top__DOT__IDU__DOT____Vcellout__CSR__csr_reg[0]),32);
    bufp->fullIData(oldp+132,(vlSelf->top__DOT__IDU__DOT____Vcellout__CSR__csr_reg[1]),32);
    bufp->fullIData(oldp+133,(vlSelf->top__DOT__IDU__DOT____Vcellout__CSR__csr_reg[2]),32);
    bufp->fullIData(oldp+134,(vlSelf->top__DOT__IDU__DOT____Vcellout__CSR__csr_reg[3]),32);
    bufp->fullIData(oldp+135,(vlSelf->top__DOT__IDU__DOT__CSR__DOT__csr_mepc),32);
    bufp->fullIData(oldp+136,(vlSelf->top__DOT__IDU__DOT__CSR__DOT__csr_mstatus),32);
    bufp->fullIData(oldp+137,(vlSelf->top__DOT__IDU__DOT__CSR__DOT__csr_mcause),32);
    bufp->fullIData(oldp+138,(vlSelf->top__DOT__IDU__DOT__CSR__DOT__csr_mtvec),32);
    bufp->fullIData(oldp+139,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[0]),32);
    bufp->fullIData(oldp+140,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[1]),32);
    bufp->fullIData(oldp+141,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[2]),32);
    bufp->fullIData(oldp+142,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[3]),32);
    bufp->fullIData(oldp+143,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[4]),32);
    bufp->fullIData(oldp+144,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[5]),32);
    bufp->fullIData(oldp+145,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[6]),32);
    bufp->fullIData(oldp+146,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[7]),32);
    bufp->fullIData(oldp+147,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[8]),32);
    bufp->fullIData(oldp+148,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[9]),32);
    bufp->fullIData(oldp+149,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[10]),32);
    bufp->fullIData(oldp+150,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[11]),32);
    bufp->fullIData(oldp+151,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[12]),32);
    bufp->fullIData(oldp+152,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[13]),32);
    bufp->fullIData(oldp+153,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[14]),32);
    bufp->fullIData(oldp+154,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[15]),32);
    bufp->fullIData(oldp+155,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[16]),32);
    bufp->fullIData(oldp+156,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[17]),32);
    bufp->fullIData(oldp+157,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[18]),32);
    bufp->fullIData(oldp+158,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[19]),32);
    bufp->fullIData(oldp+159,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[20]),32);
    bufp->fullIData(oldp+160,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[21]),32);
    bufp->fullIData(oldp+161,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[22]),32);
    bufp->fullIData(oldp+162,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[23]),32);
    bufp->fullIData(oldp+163,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[24]),32);
    bufp->fullIData(oldp+164,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[25]),32);
    bufp->fullIData(oldp+165,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[26]),32);
    bufp->fullIData(oldp+166,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[27]),32);
    bufp->fullIData(oldp+167,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[28]),32);
    bufp->fullIData(oldp+168,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[29]),32);
    bufp->fullIData(oldp+169,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[30]),32);
    bufp->fullIData(oldp+170,(vlSelf->top__DOT____Vcellout__Rgefile__reg_file[31]),32);
    bufp->fullIData(oldp+171,(vlSelf->top__DOT__Rgefile__DOT__rf[0]),32);
    bufp->fullIData(oldp+172,(vlSelf->top__DOT__Rgefile__DOT__rf[1]),32);
    bufp->fullIData(oldp+173,(vlSelf->top__DOT__Rgefile__DOT__rf[2]),32);
    bufp->fullIData(oldp+174,(vlSelf->top__DOT__Rgefile__DOT__rf[3]),32);
    bufp->fullIData(oldp+175,(vlSelf->top__DOT__Rgefile__DOT__rf[4]),32);
    bufp->fullIData(oldp+176,(vlSelf->top__DOT__Rgefile__DOT__rf[5]),32);
    bufp->fullIData(oldp+177,(vlSelf->top__DOT__Rgefile__DOT__rf[6]),32);
    bufp->fullIData(oldp+178,(vlSelf->top__DOT__Rgefile__DOT__rf[7]),32);
    bufp->fullIData(oldp+179,(vlSelf->top__DOT__Rgefile__DOT__rf[8]),32);
    bufp->fullIData(oldp+180,(vlSelf->top__DOT__Rgefile__DOT__rf[9]),32);
    bufp->fullIData(oldp+181,(vlSelf->top__DOT__Rgefile__DOT__rf[10]),32);
    bufp->fullIData(oldp+182,(vlSelf->top__DOT__Rgefile__DOT__rf[11]),32);
    bufp->fullIData(oldp+183,(vlSelf->top__DOT__Rgefile__DOT__rf[12]),32);
    bufp->fullIData(oldp+184,(vlSelf->top__DOT__Rgefile__DOT__rf[13]),32);
    bufp->fullIData(oldp+185,(vlSelf->top__DOT__Rgefile__DOT__rf[14]),32);
    bufp->fullIData(oldp+186,(vlSelf->top__DOT__Rgefile__DOT__rf[15]),32);
    bufp->fullIData(oldp+187,(vlSelf->top__DOT__Rgefile__DOT__rf[16]),32);
    bufp->fullIData(oldp+188,(vlSelf->top__DOT__Rgefile__DOT__rf[17]),32);
    bufp->fullIData(oldp+189,(vlSelf->top__DOT__Rgefile__DOT__rf[18]),32);
    bufp->fullIData(oldp+190,(vlSelf->top__DOT__Rgefile__DOT__rf[19]),32);
    bufp->fullIData(oldp+191,(vlSelf->top__DOT__Rgefile__DOT__rf[20]),32);
    bufp->fullIData(oldp+192,(vlSelf->top__DOT__Rgefile__DOT__rf[21]),32);
    bufp->fullIData(oldp+193,(vlSelf->top__DOT__Rgefile__DOT__rf[22]),32);
    bufp->fullIData(oldp+194,(vlSelf->top__DOT__Rgefile__DOT__rf[23]),32);
    bufp->fullIData(oldp+195,(vlSelf->top__DOT__Rgefile__DOT__rf[24]),32);
    bufp->fullIData(oldp+196,(vlSelf->top__DOT__Rgefile__DOT__rf[25]),32);
    bufp->fullIData(oldp+197,(vlSelf->top__DOT__Rgefile__DOT__rf[26]),32);
    bufp->fullIData(oldp+198,(vlSelf->top__DOT__Rgefile__DOT__rf[27]),32);
    bufp->fullIData(oldp+199,(vlSelf->top__DOT__Rgefile__DOT__rf[28]),32);
    bufp->fullIData(oldp+200,(vlSelf->top__DOT__Rgefile__DOT__rf[29]),32);
    bufp->fullIData(oldp+201,(vlSelf->top__DOT__Rgefile__DOT__rf[30]),32);
    bufp->fullIData(oldp+202,(vlSelf->top__DOT__Rgefile__DOT__rf[31]),32);
    ...
    bufp->fullCData(oldp+204,((0x1fU & (vlSelf->top__DOT__IDU__DOT__inst 
                                        >> 0x14U))),5);
    bufp->fullIData(oldp+205,(vlSelf->top__DOT__IDU__DOT__pc),32);
    bufp->fullIData(oldp+206,(vlSelf->top__DOT__imm_idu_to_exu),32);
    bufp->fullBit(oldp+207,(vlSelf->top__DOT__a_in_src_idu_to_exu));
    bufp->fullCData(oldp+208,(vlSelf->top__DOT__b_in_src_idu_to_exu),2);
    bufp->fullCData(oldp+209,(vlSelf->top__DOT__pc_srcs_idu_to_exu),3);
    bufp->fullBit(oldp+210,(vlSelf->top__DOT__adder_a_src_idu_to_exu));
    bufp->fullBit(oldp+211,(vlSelf->top__DOT__adder_out_src_idu_to_exu));
    bufp->fullCData(oldp+212,(vlSelf->top__DOT__alu_op_idu_to_exu),4);
    bufp->fullBit(oldp+213,(vlSelf->top__DOT__MemRead_idu_to_exu));
    bufp->fullBit(oldp+214,(vlSelf->top__DOT__MemWrite_idu_to_exu));
    bufp->fullCData(oldp+215,(vlSelf->top__DOT__wmask_idu_to_exu),8);
    bufp->fullCData(oldp+216,(vlSelf->top__DOT__rmask_idu_to_exu),3);
    bufp->fullBit(oldp+217,(vlSelf->top__DOT__wb_src_idu_to_exu));
    bufp->fullBit(oldp+218,(vlSelf->top__DOT__csr_write_idu_to_exu));
    bufp->fullBit(oldp+219,(vlSelf->top__DOT__csr_wdata_src_idu_to_exu));
    bufp->fullBit(oldp+220,(vlSelf->top__DOT__reg_write_idu_to_exu));
    bufp->fullCData(oldp+221,((0x1fU & (vlSelf->top__DOT__IDU__DOT__inst 
                                        >> 7U))),5);
    bufp->fullBit(oldp+222,(vlSelf->top__DOT__csr_write));
    bufp->fullIData(oldp+223,(vlSelf->top__DOT__csr_wdata),32);
    bufp->fullIData(oldp+224,(vlSelf->top__DOT__IDU__DOT__inst),32);
    bufp->fullCData(oldp+225,((0x7fU & vlSelf->top__DOT__IDU__DOT__inst)),7);
    bufp->fullCData(oldp+226,((7U & (vlSelf->top__DOT__IDU__DOT__inst 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+227,((vlSelf->top__DOT__IDU__DOT__inst 
                               >> 0x19U)),7);
                                         ...
                                         : ((0x305U 
                                             ...
                                             : ((0x341U 
                                                ...
                                                ((0x342U 
                                                  ...
                                                  : 0U))))
                                     : 0U)) : 0U)),32);
    bufp->fullIData(oldp+235,(vlSelf->top__DOT__LSU__DOT__datamem_readdata),32);
