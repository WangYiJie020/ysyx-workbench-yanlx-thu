...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+302,"arvalid_delay", false,-1, 4,0);
    tracep->declBus(c+303,"rready_delay", false,-1, 4,0);
    tracep->declBit(c+304,"lfsr_in", false,-1);
    tracep->declBit(c+6,"arvalid", false,-1);
    tracep->declBus(c+290,"araddr", false,-1, 31,0);
    tracep->declBit(c+10,"rready", false,-1);
    tracep->declBus(c+305,"arvalid_buffer", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+306+i*1,"araddr_buffer", true,(i+0), 31,0);
    }
    tracep->declBus(c+338,"rready_buffer", false,-1, 31,0);
    tracep->declBus(c+339,"S_IDLE", false,-1, 2,0);
    tracep->declBus(c+340,"S_RECEIVE", false,-1, 2,0);
    tracep->declBus(c+341,"S_SEND", false,-1, 2,0);
    tracep->declBus(c+342,"S_WAIT_RECEIVE", false,-1, 2,0);
    tracep->declBus(c+343,"S_WAIT_SEND", false,-1, 2,0);
    ...
    tracep->declBus(c+345,"awaddr_i", false,-1, 31,0);
    tracep->declBit(c+346,"awvalid_i", false,-1);
    tracep->declBit(c+11,"awready_o", false,-1);
    tracep->declBus(c+345,"wdata_i", false,-1, 31,0);
    tracep->declBus(c+347,"wstrb_i", false,-1, 7,0);
    tracep->declBit(c+346,"wvalid_i", false,-1);
    tracep->declBit(c+12,"wready_o", false,-1);
    tracep->declBit(c+13,"bresp_o", false,-1);
    tracep->declBit(c+14,"bvalid_o", false,-1);
    tracep->declBit(c+346,"bready_i", false,-1);
    ...
    tracep->declBit(c+348,"b_state", false,-1);
    ...
    tracep->declBit(c+349,"wvalid", false,-1);
    ...
    tracep->declBus(c+350,"rs2", false,-1, 31,0);
    tracep->declBus(c+351,"csr_rdata_l_rs1", false,-1, 31,0);
    tracep->declBus(c+67,"rmask", false,-1, 2,0);
    tracep->declBit(c+37,"flag", false,-1);
    tracep->declBit(c+352,"wvalid_tmp", false,-1);
    tracep->declBus(c+38,"LFSR", false,-1, 4,0);
    tracep->declBit(c+39,"lfsr_in", false,-1);
    tracep->declBus(c+296,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+297,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+298,"S_SEND", false,-1, 1,0);
    tracep->declBus(c+353,"S_WAIT_SEND", false,-1, 1,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+302,(vlSelf->top__DOT__IFU__DOT__arvalid_delay),5);
    bufp->fullCData(oldp+303,(vlSelf->top__DOT__IFU__DOT__rready_delay),5);
    bufp->fullBit(oldp+304,(vlSelf->top__DOT__IFU__DOT__lfsr_in));
    bufp->fullIData(oldp+305,(vlSelf->top__DOT__IFU__DOT__arvalid_buffer),32);
    bufp->fullIData(oldp+306,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[0]),32);
    bufp->fullIData(oldp+307,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[1]),32);
    bufp->fullIData(oldp+308,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[2]),32);
    bufp->fullIData(oldp+309,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[3]),32);
    bufp->fullIData(oldp+310,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[4]),32);
    bufp->fullIData(oldp+311,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[5]),32);
    bufp->fullIData(oldp+312,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[6]),32);
    bufp->fullIData(oldp+313,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[7]),32);
    bufp->fullIData(oldp+314,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[8]),32);
    bufp->fullIData(oldp+315,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[9]),32);
    bufp->fullIData(oldp+316,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[10]),32);
    bufp->fullIData(oldp+317,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[11]),32);
    bufp->fullIData(oldp+318,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[12]),32);
    bufp->fullIData(oldp+319,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[13]),32);
    bufp->fullIData(oldp+320,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[14]),32);
    bufp->fullIData(oldp+321,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[15]),32);
    bufp->fullIData(oldp+322,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[16]),32);
    bufp->fullIData(oldp+323,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[17]),32);
    bufp->fullIData(oldp+324,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[18]),32);
    bufp->fullIData(oldp+325,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[19]),32);
    bufp->fullIData(oldp+326,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[20]),32);
    bufp->fullIData(oldp+327,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[21]),32);
    bufp->fullIData(oldp+328,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[22]),32);
    bufp->fullIData(oldp+329,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[23]),32);
    bufp->fullIData(oldp+330,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[24]),32);
    bufp->fullIData(oldp+331,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[25]),32);
    bufp->fullIData(oldp+332,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[26]),32);
    bufp->fullIData(oldp+333,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[27]),32);
    bufp->fullIData(oldp+334,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[28]),32);
    bufp->fullIData(oldp+335,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[29]),32);
    bufp->fullIData(oldp+336,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[30]),32);
    bufp->fullIData(oldp+337,(vlSelf->top__DOT__IFU__DOT__araddr_buffer[31]),32);
    bufp->fullIData(oldp+338,(vlSelf->top__DOT__IFU__DOT__rready_buffer),32);
    bufp->fullCData(oldp+339,(0U),3);
    bufp->fullCData(oldp+340,(1U),3);
    bufp->fullCData(oldp+341,(2U),3);
    bufp->fullCData(oldp+342,(3U),3);
    bufp->fullCData(oldp+343,(4U),3);
    bufp->fullIData(oldp+344,(0x80000000U),32);
    bufp->fullIData(oldp+345,(0U),32);
    bufp->fullBit(oldp+346,(0U));
    bufp->fullCData(oldp+347,(0U),8);
    bufp->fullBit(oldp+348,(vlSelf->top__DOT__Inst_Mem__DOT__b_state));
    bufp->fullBit(oldp+349,(vlSelf->top__DOT__Inst_Mem__DOT__wvalid));
    bufp->fullIData(oldp+350,(vlSelf->top__DOT__LSU__DOT__rs2),32);
    bufp->fullIData(oldp+351,(vlSelf->top__DOT__LSU__DOT__csr_rdata_l_rs1),32);
    bufp->fullBit(oldp+352,(vlSelf->top__DOT__LSU__DOT__wvalid_tmp));
    bufp->fullCData(oldp+353,(3U),2);
