...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+35,"npc_wbu_to_ifu", false,-1, 31,0);
    tracep->declBit(c+36,"valid_wbu_to_ifu", false,-1);
    ...
    tracep->declBit(c+37,"ready_idu_to_exu", false,-1);
    ...
    tracep->declBit(c+40,"reg_write", false,-1);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+133+i*1,"reg_file", true,(i+0), 31,0);
    }
    tracep->declBus(c+41,"alu_result_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+42,"rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+43,"rs2_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+44,"csr_rdata_l_rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+45,"npc_exu_to_lsu", false,-1, 31,0);
    tracep->declBit(c+46,"MemRead_exu_to_lsu", false,-1);
    tracep->declBit(c+47,"MemWrite_exu_to_lsu", false,-1);
    tracep->declBus(c+48,"wmask_exu_to_lsu", false,-1, 7,0);
    tracep->declBus(c+49,"rmask_exu_to_lsu", false,-1, 2,0);
    tracep->declBit(c+50,"wb_src_exu_to_lsu", false,-1);
    tracep->declBit(c+51,"csr_write_exu_to_lsu", false,-1);
    tracep->declBit(c+52,"csr_wdta_src_exu_to_lsu", false,-1);
    tracep->declBit(c+53,"reg_write_exu_to_lsu", false,-1);
    tracep->declBus(c+54,"waddr_exu_to_lsu", false,-1, 4,0);
    tracep->declBit(c+55,"valid_exu_to_lsu", false,-1);
    tracep->declBit(c+56,"ready_exu_to_lsu", false,-1);
    tracep->declBus(c+57,"alu_result_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+58,"rs1_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+59,"csr_rdata_l_rs1_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+60,"datamem_readdata_lsu_to_wbu", false,-1, 31,0);
    ...
    tracep->declBus(c+57,"lsu_araddr", false,-1, 31,0);
    tracep->declBit(c+70,"lsu_arvalid", false,-1);
    tracep->declBit(c+16,"lsu_arready", false,-1);
    tracep->declBus(c+60,"lsu_rdata", false,-1, 31,0);
    ...
    tracep->declBit(c+266,"clk", false,-1);
    tracep->declBit(c+267,"rst_n", false,-1);
    tracep->declBus(c+57,"araddr_i", false,-1, 31,0);
    tracep->declBit(c+70,"arvalid_i", false,-1);
    tracep->declBit(c+16,"arready_o", false,-1);
    tracep->declBus(c+60,"rdata_o", false,-1, 31,0);
    ...
    tracep->declBit(c+84,"aw_state", false,-1);
    tracep->declBit(c+18,"w_state", false,-1);
    tracep->declBit(c+19,"b_state", false,-1);
    ...
    tracep->declBit(c+37,"exu_ready_o", false,-1);
    tracep->declBus(c+41,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+42,"rs1_o", false,-1, 31,0);
    tracep->declBus(c+43,"rs2_o", false,-1, 31,0);
    tracep->declBus(c+44,"csr_rdata_l_rs1_o", false,-1, 31,0);
    tracep->declBus(c+45,"npc_o", false,-1, 31,0);
    tracep->declBit(c+46,"MemRead_o", false,-1);
    tracep->declBit(c+47,"MemWrite_o", false,-1);
    tracep->declBus(c+48,"wmask_o", false,-1, 7,0);
    tracep->declBus(c+49,"rmask_o", false,-1, 2,0);
    tracep->declBit(c+50,"wb_src_o", false,-1);
    tracep->declBit(c+51,"csr_write_o", false,-1);
    tracep->declBit(c+52,"csr_wdata_src_o", false,-1);
    tracep->declBit(c+53,"reg_write_o", false,-1);
    tracep->declBus(c+54,"waddr_o", false,-1, 4,0);
    tracep->declBit(c+55,"exu_valid_o", false,-1);
    tracep->declBit(c+56,"exu_ready_i", false,-1);
    ...
    tracep->declBit(c+37,"idu_ready_i", false,-1);
    ...
    tracep->declBit(c+36,"ifu_valid_i", false,-1);
    ...
    tracep->declBus(c+33,"wstrb", false,-1, 7,0);
    ...
    tracep->declBus(c+43,"rs2_i", false,-1, 31,0);
    tracep->declBus(c+44,"csr_rdata_l_rs1_i", false,-1, 31,0);
    tracep->declBus(c+45,"npc_i", false,-1, 31,0);
    tracep->declBit(c+46,"MemRead_i", false,-1);
    tracep->declBit(c+47,"MemWrite_i", false,-1);
    tracep->declBus(c+48,"wmask_i", false,-1, 7,0);
    tracep->declBus(c+49,"rmask_i", false,-1, 2,0);
    tracep->declBit(c+50,"wb_src_i", false,-1);
    tracep->declBit(c+51,"csr_write_i", false,-1);
    tracep->declBit(c+52,"csr_wdata_src_i", false,-1);
    tracep->declBit(c+53,"reg_write_i", false,-1);
    tracep->declBus(c+54,"waddr_i", false,-1, 4,0);
    tracep->declBit(c+55,"lsu_valid_i", false,-1);
    tracep->declBit(c+56,"lsu_ready_o", false,-1);
    tracep->declBus(c+57,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+58,"rs1_o", false,-1, 31,0);
    tracep->declBus(c+59,"csr_rdata_l_rs1_o", false,-1, 31,0);
    tracep->declBus(c+60,"datamem_readdata_o", false,-1, 31,0);
    ...
    tracep->declBus(c+58,"rs1", false,-1, 31,0);
    ...
    tracep->declBit(c+34,"flag", false,-1);
    tracep->declBus(c+273,"S_IDLE", false,-1, 1,0);
    tracep->declBus(c+274,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+275,"S_SEND", false,-1, 1,0);
    ...
    tracep->declBit(c+266,"clk", false,-1);
    tracep->declBit(c+267,"rst_n", false,-1);
    tracep->declBus(c+57,"alu_result_i", false,-1, 31,0);
    tracep->declBus(c+58,"rs1_i", false,-1, 31,0);
    tracep->declBus(c+59,"csr_rdata_l_rs1_i", false,-1, 31,0);
    tracep->declBus(c+60,"datamem_readdata_i", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+18,(vlSelf->top__DOT__Data_Mem__DOT__w_state));
    bufp->fullBit(oldp+19,(vlSelf->top__DOT__Data_Mem__DOT__b_state));
    ...
    bufp->fullCData(oldp+33,(vlSelf->top__DOT__Inst_Mem__DOT__wstrb),8);
    bufp->fullBit(oldp+34,(vlSelf->top__DOT__LSU__DOT__flag));
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__npc_wbu_to_ifu),32);
    bufp->fullBit(oldp+36,(vlSelf->top__DOT__valid_wbu_to_ifu));
    bufp->fullBit(oldp+37,(vlSelf->top__DOT__ready_idu_to_exu));
    bufp->fullIData(oldp+38,(((IData)(vlSelf->top__DOT__WBU__DOT__wb_src)
                               ? vlSelf->top__DOT__WBU__DOT__mem_data
                               : vlSelf->top__DOT__WBU__DOT__alu_result)),32);
    bufp->fullCData(oldp+39,(vlSelf->top__DOT__waddr),5);
    bufp->fullBit(oldp+40,(vlSelf->top__DOT__reg_write));
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__EXU__DOT__alu_result),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__EXU__DOT__rs1),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__EXU__DOT__rs2),32);
    bufp->fullIData(oldp+44,((vlSelf->top__DOT__EXU__DOT__csr_rdata 
                              | vlSelf->top__DOT__EXU__DOT__rs1)),32);
    bufp->fullIData(oldp+45,(((4U & (IData)(vlSelf->top__DOT__EXU__DOT__pc_srcs))
    ...
    bufp->fullBit(oldp+46,(vlSelf->top__DOT__MemRead_exu_to_lsu));
    bufp->fullBit(oldp+47,(vlSelf->top__DOT__MemWrite_exu_to_lsu));
    bufp->fullCData(oldp+48,(vlSelf->top__DOT__wmask_exu_to_lsu),8);
    bufp->fullCData(oldp+49,(vlSelf->top__DOT__rmask_exu_to_lsu),3);
    bufp->fullBit(oldp+50,(vlSelf->top__DOT__wb_src_exu_to_lsu));
    bufp->fullBit(oldp+51,(vlSelf->top__DOT__csr_write_exu_to_lsu));
    bufp->fullBit(oldp+52,(vlSelf->top__DOT__csr_wdta_src_exu_to_lsu));
    bufp->fullBit(oldp+53,(vlSelf->top__DOT__reg_write_exu_to_lsu));
    bufp->fullCData(oldp+54,(vlSelf->top__DOT__waddr_exu_to_lsu),5);
    bufp->fullBit(oldp+55,(vlSelf->top__DOT__valid_exu_to_lsu));
    bufp->fullBit(oldp+56,(vlSelf->top__DOT__ready_exu_to_lsu));
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__LSU__DOT__alu_result),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__LSU__DOT__rs1),32);
    bufp->fullIData(oldp+59,(vlSelf->top__DOT__csr_rdata_l_rs1_lsu_to_wbu),32);
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__lsu_rdata),32);
    ...
    bufp->fullBit(oldp+84,(vlSelf->top__DOT__Data_Mem__DOT__aw_state));
