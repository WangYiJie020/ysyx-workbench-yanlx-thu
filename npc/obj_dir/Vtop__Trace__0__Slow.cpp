...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+23,"npc_wbu_to_ifu", false,-1, 31,0);
    tracep->declBit(c+24,"valid_wbu_to_ifu", false,-1);
    tracep->declBit(c+25,"ready_wbu_to_ifu", false,-1);
    tracep->declBus(c+2,"pc_ifu_to_idu", false,-1, 31,0);
    tracep->declBus(c+3,"inst_ifu_to_idu", false,-1, 31,0);
    tracep->declBit(c+26,"valid_ifu_to_idu", false,-1);
    tracep->declBit(c+4,"ready_ifu_to_idu", false,-1);
    tracep->declBus(c+249,"ifu_araddr", false,-1, 31,0);
    tracep->declBit(c+27,"ifu_arvalid", false,-1);
    tracep->declBit(c+5,"ifu_arready", false,-1);
    tracep->declBus(c+1,"ifu_rdata", false,-1, 31,0);
    tracep->declBit(c+6,"ifu_rresp", false,-1);
    tracep->declBit(c+7,"ifu_rvalid", false,-1);
    tracep->declBit(c+28,"ifu_rready", false,-1);
    tracep->declBit(c+8,"useless1", false,-1);
    tracep->declBit(c+9,"useless2", false,-1);
    tracep->declBit(c+10,"useless3", false,-1);
    tracep->declBit(c+11,"useless4", false,-1);
    ...
    tracep->declBit(c+12,"valid_idu_to_exu", false,-1);
    ...
    tracep->declBus(c+52,"npc_lsu_to_wbu", false,-1, 31,0);
    tracep->declBus(c+53,"rmask_lsu_to_wbu", false,-1, 2,0);
    tracep->declBit(c+54,"wb_src_lsu_to_wbu", false,-1);
    tracep->declBit(c+55,"csr_write_lsu_to_wbu", false,-1);
    tracep->declBit(c+56,"csr_wdata_src_lsu_to_wbu", false,-1);
    tracep->declBit(c+57,"reg_write_lsu_to_wbu", false,-1);
    tracep->declBus(c+58,"waddr_lsu_to_wbu", false,-1, 4,0);
    tracep->declBit(c+59,"valid_lsu_to_wbu", false,-1);
    tracep->declBit(c+60,"ready_lsu_to_wbu", false,-1);
    ...
    tracep->declBit(c+12,"exu_valid_i", false,-1);
    ...
    tracep->declBus(c+63,"csr_rdata", false,-1, 31,0);
    tracep->declBit(c+64,"a_in_src", false,-1);
    tracep->declBus(c+65,"b_in_src", false,-1, 1,0);
    tracep->declBus(c+66,"pc_srcs", false,-1, 2,0);
    tracep->declBit(c+67,"adder_a_src", false,-1);
    tracep->declBit(c+68,"adder_out_src", false,-1);
    tracep->declBus(c+69,"alu_op", false,-1, 3,0);
    tracep->declBus(c+70,"a_in", false,-1, 31,0);
    tracep->declBus(c+71,"b_in", false,-1, 31,0);
    tracep->declBus(c+72,"a_out", false,-1, 31,0);
    tracep->declBus(c+73,"add_out", false,-1, 31,0);
    tracep->declBus(c+74,"pc_new", false,-1, 31,0);
    ...
    tracep->declBus(c+76,"current_state", false,-1, 1,0);
    tracep->declBus(c+77,"next_state", false,-1, 1,0);
    tracep->pushNamePrefix("ALU ");
    tracep->declBus(c+70,"a", false,-1, 31,0);
    tracep->declBus(c+71,"b", false,-1, 31,0);
    tracep->declBus(c+69,"op", false,-1, 3,0);
    tracep->declBus(c+33,"alu_result", false,-1, 31,0);
    tracep->declBit(c+75,"zero", false,-1);
    ...
    tracep->declBus(c+65,"sel", false,-1, 1,0);
    ...
    tracep->declBus(c+257,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+61,"d0", false,-1, 31,0);
    ...
    tracep->declBus(c+78,"pc4", false,-1, 31,0);
    tracep->declBus(c+74,"pc_new", false,-1, 31,0);
    tracep->declBus(c+66,"pc_srcs", false,-1, 2,0);
    tracep->declBit(c+75,"zero", false,-1);
    tracep->declBus(c+33,"alu_result", false,-1, 31,0);
    ...
    tracep->declBit(c+4,"idu_ready_o", false,-1);
    ...
    tracep->declBit(c+12,"idu_valid_o", false,-1);
    ...
    tracep->declBus(c+255,"S_RECEIVE", false,-1, 1,0);
    tracep->declBus(c+256,"S_SEND", false,-1, 1,0);
    tracep->declBus(c+13,"current_state", false,-1, 1,0);
    ...
    tracep->declBit(c+27,"arvalid_o", false,-1);
    tracep->declBit(c+5,"arready_i", false,-1);
    tracep->declBus(c+1,"rdata_i", false,-1, 31,0);
    tracep->declBit(c+6,"rresp_i", false,-1);
    tracep->declBit(c+7,"rvalid_i", false,-1);
    tracep->declBit(c+28,"rready_o", false,-1);
    tracep->declBus(c+23,"npc_i", false,-1, 31,0);
    tracep->declBit(c+24,"ifu_valid_i", false,-1);
    tracep->declBit(c+25,"ifu_ready_o", false,-1);
    tracep->declBus(c+2,"pc_o", false,-1, 31,0);
    tracep->declBus(c+3,"inst_o", false,-1, 31,0);
    tracep->declBit(c+26,"ifu_valid_o", false,-1);
    tracep->declBit(c+4,"ifu_ready_i", false,-1);
    ...
    tracep->declBus(c+81,"current_state", false,-1, 1,0);
    ...
    tracep->declBit(c+27,"arvalid_i", false,-1);
    tracep->declBit(c+5,"arready_o", false,-1);
    tracep->declBus(c+1,"rdata_o", false,-1, 31,0);
    tracep->declBit(c+6,"rresp_o", false,-1);
    tracep->declBit(c+7,"rvalid_o", false,-1);
    tracep->declBit(c+28,"rready_i", false,-1);
    tracep->declBus(c+261,"awaddr_i", false,-1, 31,0);
    tracep->declBit(c+262,"awvalid_i", false,-1);
    tracep->declBit(c+8,"awready_o", false,-1);
    tracep->declBus(c+261,"wdata_i", false,-1, 31,0);
    tracep->declBus(c+263,"wstrb_i", false,-1, 7,0);
    tracep->declBit(c+262,"wvalid_i", false,-1);
    tracep->declBit(c+9,"wready_o", false,-1);
    tracep->declBit(c+10,"bresp_o", false,-1);
    tracep->declBit(c+11,"bvalid_o", false,-1);
    tracep->declBit(c+262,"bready_i", false,-1);
    tracep->declBit(c+14,"ar_state", false,-1);
    tracep->declBit(c+15,"r_state", false,-1);
    tracep->declBit(c+16,"aw_state", false,-1);
    tracep->declBit(c+17,"w_state", false,-1);
    tracep->declBit(c+18,"b_state", false,-1);
    tracep->declBus(c+19,"araddr", false,-1, 31,0);
    ...
    tracep->declBus(c+53,"rmask_o", false,-1, 2,0);
    tracep->declBit(c+54,"wb_src_o", false,-1);
    tracep->declBit(c+55,"csr_write_o", false,-1);
    tracep->declBit(c+56,"csr_wdata_src_o", false,-1);
    tracep->declBit(c+57,"reg_write_o", false,-1);
    tracep->declBus(c+58,"waddr_o", false,-1, 4,0);
    tracep->declBit(c+59,"lsu_valid_o", false,-1);
    tracep->declBit(c+60,"lsu_ready_i", false,-1);
    ...
    tracep->declBus(c+53,"rmask", false,-1, 2,0);
    ...
    tracep->declBus(c+53,"rmask_i", false,-1, 2,0);
    tracep->declBit(c+54,"wb_src_i", false,-1);
    tracep->declBit(c+55,"csr_write_i", false,-1);
    tracep->declBit(c+56,"csr_wdata_src_i", false,-1);
    tracep->declBit(c+57,"reg_write_i", false,-1);
    tracep->declBus(c+58,"waddr_i", false,-1, 4,0);
    tracep->declBit(c+59,"wbu_valid_i", false,-1);
    tracep->declBit(c+60,"wbu_ready_o", false,-1);
    tracep->declBus(c+23,"npc_o", false,-1, 31,0);
    tracep->declBit(c+24,"wbu_valid_o", false,-1);
    tracep->declBit(c+25,"wbu_ready_i", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,(vlSelf->top__DOT__pc_ifu_to_idu),32);
    bufp->fullIData(oldp+3,(vlSelf->top__DOT__inst_ifu_to_idu),32);
    bufp->fullBit(oldp+4,(vlSelf->top__DOT__ready_ifu_to_idu));
    bufp->fullBit(oldp+5,(vlSelf->top__DOT__ifu_arready));
    bufp->fullBit(oldp+6,(vlSelf->top__DOT__ifu_rresp));
    bufp->fullBit(oldp+7,(vlSelf->top__DOT__ifu_rvalid));
    bufp->fullBit(oldp+8,(vlSelf->top__DOT__useless1));
    bufp->fullBit(oldp+9,(vlSelf->top__DOT__useless2));
    bufp->fullBit(oldp+10,(vlSelf->top__DOT__useless3));
    bufp->fullBit(oldp+11,(vlSelf->top__DOT__useless4));
    bufp->fullBit(oldp+12,(vlSelf->top__DOT__valid_idu_to_exu));
    bufp->fullCData(oldp+13,(vlSelf->top__DOT__IDU__DOT__current_state),2);
    bufp->fullBit(oldp+14,(vlSelf->top__DOT__Inst_Mem__DOT__ar_state));
    bufp->fullBit(oldp+15,(vlSelf->top__DOT__Inst_Mem__DOT__r_state));
    bufp->fullBit(oldp+16,(vlSelf->top__DOT__Inst_Mem__DOT__aw_state));
    bufp->fullBit(oldp+17,(vlSelf->top__DOT__Inst_Mem__DOT__w_state));
    bufp->fullBit(oldp+18,(vlSelf->top__DOT__Inst_Mem__DOT__b_state));
    bufp->fullIData(oldp+19,(vlSelf->top__DOT__Inst_Mem__DOT__araddr),32);
    bufp->fullIData(oldp+20,(vlSelf->top__DOT__Inst_Mem__DOT__awaddr),32);
    bufp->fullIData(oldp+21,(vlSelf->top__DOT__Inst_Mem__DOT__wdata),32);
    bufp->fullBit(oldp+22,(vlSelf->top__DOT__LSU__DOT__flag));
    bufp->fullIData(oldp+23,(vlSelf->top__DOT__npc_wbu_to_ifu),32);
    bufp->fullBit(oldp+24,(vlSelf->top__DOT__valid_wbu_to_ifu));
    bufp->fullBit(oldp+25,(vlSelf->top__DOT__ready_wbu_to_ifu));
    bufp->fullBit(oldp+26,(vlSelf->top__DOT__valid_ifu_to_idu));
    bufp->fullBit(oldp+27,(vlSelf->top__DOT__ifu_arvalid));
    bufp->fullBit(oldp+28,(vlSelf->top__DOT__ifu_rready));
    ...
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__npc_lsu_to_wbu),32);
    bufp->fullCData(oldp+53,(vlSelf->top__DOT__LSU__DOT__rmask),3);
    bufp->fullBit(oldp+54,(vlSelf->top__DOT__wb_src_lsu_to_wbu));
    bufp->fullBit(oldp+55,(vlSelf->top__DOT__csr_write_lsu_to_wbu));
    bufp->fullBit(oldp+56,(vlSelf->top__DOT__csr_wdata_src_lsu_to_wbu));
    bufp->fullBit(oldp+57,(vlSelf->top__DOT__reg_write_lsu_to_wbu));
    bufp->fullCData(oldp+58,(vlSelf->top__DOT__waddr_lsu_to_wbu),5);
    bufp->fullBit(oldp+59,(vlSelf->top__DOT__valid_lsu_to_wbu));
    bufp->fullBit(oldp+60,(vlSelf->top__DOT__ready_lsu_to_wbu));
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__EXU__DOT__pc),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__EXU__DOT__imm),32);
    bufp->fullIData(oldp+63,(vlSelf->top__DOT__EXU__DOT__csr_rdata),32);
    bufp->fullBit(oldp+64,(vlSelf->top__DOT__EXU__DOT__a_in_src));
    bufp->fullCData(oldp+65,(vlSelf->top__DOT__EXU__DOT__b_in_src),2);
    bufp->fullCData(oldp+66,(vlSelf->top__DOT__EXU__DOT__pc_srcs),3);
    bufp->fullBit(oldp+67,(vlSelf->top__DOT__EXU__DOT__adder_a_src));
    bufp->fullBit(oldp+68,(vlSelf->top__DOT__EXU__DOT__adder_out_src));
    bufp->fullCData(oldp+69,(vlSelf->top__DOT__EXU__DOT__alu_op),4);
    bufp->fullIData(oldp+70,(vlSelf->top__DOT__EXU__DOT__a_in),32);
    bufp->fullIData(oldp+71,(vlSelf->top__DOT__EXU__DOT__b_in),32);
    ...
    bufp->fullIData(oldp+74,(vlSelf->top__DOT__EXU__DOT__pc_new),32);
    bufp->fullBit(oldp+75,((1U & (~ (IData)((0U != vlSelf->top__DOT__EXU__DOT__alu_result))))));
    bufp->fullCData(oldp+76,(vlSelf->top__DOT__EXU__DOT__current_state),2);
    bufp->fullCData(oldp+77,(vlSelf->top__DOT__EXU__DOT__next_state),2);
    bufp->fullIData(oldp+78,(((IData)(4U) + vlSelf->top__DOT__EXU__DOT__pc)),32);
    bufp->fullCData(oldp+79,(vlSelf->top__DOT__IDU__DOT__next_state),2);
    bufp->fullIData(oldp+80,(vlSelf->top__DOT__IFU__DOT__npc),32);
    bufp->fullCData(oldp+81,(vlSelf->top__DOT__IFU__DOT__current_state),2);
