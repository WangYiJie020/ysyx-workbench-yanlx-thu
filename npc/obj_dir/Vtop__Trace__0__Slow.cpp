...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+37,"npc_wbu_to_ifu", false,-1, 31,0);
    tracep->declBit(c+38,"valid_wbu_to_ifu", false,-1);
    ...
    tracep->declBit(c+39,"ready_idu_to_exu", false,-1);
    ...
    tracep->declBit(c+42,"reg_write", false,-1);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+133+i*1,"reg_file", true,(i+0), 31,0);
    }
    tracep->declBus(c+43,"alu_result_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+44,"rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+45,"rs2_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+46,"csr_rdata_l_rs1_exu_to_lsu", false,-1, 31,0);
    tracep->declBus(c+47,"npc_exu_to_lsu", false,-1, 31,0);
    tracep->declBit(c+48,"MemRead_exu_to_lsu", false,-1);
    tracep->declBit(c+49,"MemWrite_exu_to_lsu", false,-1);
    tracep->declBus(c+50,"wmask_exu_to_lsu", false,-1, 7,0);
    tracep->declBus(c+51,"rmask_exu_to_lsu", false,-1, 2,0);
    tracep->declBit(c+52,"wb_src_exu_to_lsu", false,-1);
    tracep->declBit(c+53,"csr_write_exu_to_lsu", false,-1);
    tracep->declBit(c+54,"csr_wdta_src_exu_to_lsu", false,-1);
    tracep->declBit(c+55,"reg_write_exu_to_lsu", false,-1);
    tracep->declBus(c+56,"waddr_exu_to_lsu", false,-1, 4,0);
    tracep->declBit(c+57,"valid_exu_to_lsu", false,-1);
    tracep->declBit(c+58,"ready_exu_to_lsu", false,-1);
    ...
    tracep->declBit(c+39,"exu_ready_o", false,-1);
    tracep->declBus(c+43,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+44,"rs1_o", false,-1, 31,0);
    tracep->declBus(c+45,"rs2_o", false,-1, 31,0);
    tracep->declBus(c+46,"csr_rdata_l_rs1_o", false,-1, 31,0);
    tracep->declBus(c+47,"npc_o", false,-1, 31,0);
    tracep->declBit(c+48,"MemRead_o", false,-1);
    tracep->declBit(c+49,"MemWrite_o", false,-1);
    tracep->declBus(c+50,"wmask_o", false,-1, 7,0);
    tracep->declBus(c+51,"rmask_o", false,-1, 2,0);
    tracep->declBit(c+52,"wb_src_o", false,-1);
    tracep->declBit(c+53,"csr_write_o", false,-1);
    tracep->declBit(c+54,"csr_wdata_src_o", false,-1);
    tracep->declBit(c+55,"reg_write_o", false,-1);
    tracep->declBus(c+56,"waddr_o", false,-1, 4,0);
    tracep->declBit(c+57,"exu_valid_o", false,-1);
    tracep->declBit(c+58,"exu_ready_i", false,-1);
    ...
    tracep->declBus(c+43,"alu_result", false,-1, 31,0);
    ...
    tracep->declBit(c+39,"idu_ready_i", false,-1);
    ...
    tracep->declBit(c+38,"ifu_valid_i", false,-1);
    ...
    tracep->declBit(c+266,"clk", false,-1);
    tracep->declBit(c+267,"rst_n", false,-1);
    tracep->declBus(c+43,"alu_result_i", false,-1, 31,0);
    tracep->declBus(c+44,"rs1_i", false,-1, 31,0);
    tracep->declBus(c+45,"rs2_i", false,-1, 31,0);
    tracep->declBus(c+46,"csr_rdata_l_rs1_i", false,-1, 31,0);
    tracep->declBus(c+47,"npc_i", false,-1, 31,0);
    tracep->declBit(c+48,"MemRead_i", false,-1);
    tracep->declBit(c+49,"MemWrite_i", false,-1);
    tracep->declBus(c+50,"wmask_i", false,-1, 7,0);
    tracep->declBus(c+51,"rmask_i", false,-1, 2,0);
    tracep->declBit(c+52,"wb_src_i", false,-1);
    tracep->declBit(c+53,"csr_write_i", false,-1);
    tracep->declBit(c+54,"csr_wdata_src_i", false,-1);
    tracep->declBit(c+55,"reg_write_i", false,-1);
    tracep->declBus(c+56,"waddr_i", false,-1, 4,0);
    tracep->declBit(c+57,"lsu_valid_i", false,-1);
    tracep->declBit(c+58,"lsu_ready_o", false,-1);
    ...
    tracep->declBit(c+71,"wbu_ready_o", false,-1);
    tracep->declBus(c+37,"npc_o", false,-1, 31,0);
    tracep->declBit(c+38,"wbu_valid_o", false,-1);
    ...
    tracep->declBit(c+42,"reg_write_o", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__npc_wbu_to_ifu),32);
    bufp->fullBit(oldp+38,(vlSelf->top__DOT__valid_wbu_to_ifu));
    bufp->fullBit(oldp+39,(vlSelf->top__DOT__ready_idu_to_exu));
    bufp->fullIData(oldp+40,(((IData)(vlSelf->top__DOT__WBU__DOT__wb_src)
                               ? vlSelf->top__DOT__WBU__DOT__mem_data
                               : vlSelf->top__DOT__WBU__DOT__alu_result)),32);
    bufp->fullCData(oldp+41,(vlSelf->top__DOT__waddr),5);
    bufp->fullBit(oldp+42,(vlSelf->top__DOT__reg_write));
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__EXU__DOT__alu_result),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__EXU__DOT__rs1),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__EXU__DOT__rs2),32);
    bufp->fullIData(oldp+46,((vlSelf->top__DOT__EXU__DOT__csr_rdata 
                              | vlSelf->top__DOT__EXU__DOT__rs1)),32);
    bufp->fullIData(oldp+47,(((4U & (IData)(vlSelf->top__DOT__EXU__DOT__pc_srcs))
    ...
    bufp->fullBit(oldp+48,(vlSelf->top__DOT__MemRead_exu_to_lsu));
    bufp->fullBit(oldp+49,(vlSelf->top__DOT__MemWrite_exu_to_lsu));
    bufp->fullCData(oldp+50,(vlSelf->top__DOT__wmask_exu_to_lsu),8);
    bufp->fullCData(oldp+51,(vlSelf->top__DOT__rmask_exu_to_lsu),3);
    bufp->fullBit(oldp+52,(vlSelf->top__DOT__wb_src_exu_to_lsu));
    bufp->fullBit(oldp+53,(vlSelf->top__DOT__csr_write_exu_to_lsu));
    bufp->fullBit(oldp+54,(vlSelf->top__DOT__csr_wdta_src_exu_to_lsu));
    bufp->fullBit(oldp+55,(vlSelf->top__DOT__reg_write_exu_to_lsu));
    bufp->fullCData(oldp+56,(vlSelf->top__DOT__waddr_exu_to_lsu),5);
    bufp->fullBit(oldp+57,(vlSelf->top__DOT__valid_exu_to_lsu));
    bufp->fullBit(oldp+58,(vlSelf->top__DOT__ready_exu_to_lsu));
    ...
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__lsu_rdata),32);
    ...
    bufp->fullBit(oldp+71,(vlSelf->top__DOT__ready_lsu_to_wbu));
