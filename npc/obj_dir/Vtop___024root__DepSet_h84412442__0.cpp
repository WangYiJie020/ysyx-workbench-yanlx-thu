...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__top__DOT__Inst_Mem__DOT__flag_waddr 
        = vlSelf->top__DOT__Inst_Mem__DOT__flag_waddr;
    ...
    vlSelf->__Vdly__top__DOT__Data_Mem__DOT__flag_waddr 
        = vlSelf->top__DOT__Data_Mem__DOT__flag_waddr;
    ...
    if (vlSelf->rst_n) {
        ...
        vlSelf->__Vdly__top__DOT__Data_Mem__DOT__araddr = 0U;
        vlSelf->top__DOT__valid_idu_to_exu = 0U;
        vlSelf->top__DOT__ready_ifu_to_idu = 0U;
        vlSelf->top__DOT__lsu_arready = 0U;
        vlSelf->top__DOT__Data_Mem__DOT__ar_state = 0U;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->top__DOT__Data_Mem__DOT__flag_waddr) 
        ...
        vlSelf->__Vdly__top__DOT__Data_Mem__DOT__flag_waddr = 0U;
    ...
    if (((IData)(vlSelf->top__DOT__Inst_Mem__DOT__flag_waddr) 
        ...
        vlSelf->__Vdly__top__DOT__Inst_Mem__DOT__flag_waddr = 0U;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    __Vtableidx2 = 0;
    // Body
    vlSelf->top__DOT__Data_Mem__DOT__flag_waddr = vlSelf->__Vdly__top__DOT__Data_Mem__DOT__flag_waddr;
    vlSelf->top__DOT__Inst_Mem__DOT__flag_waddr = vlSelf->__Vdly__top__DOT__Inst_Mem__DOT__flag_waddr;
    vlSelf->top__DOT__IFU__DOT__npc = vlSelf->__Vdly__top__DOT__IFU__DOT__npc;
    if ((1U & (~ (IData)(vlSelf->rst_n)))) {
        vlSelf->top__DOT__Inst_Mem__DOT__awaddr = 0U;
    }
    __Vtableidx2 = (((IData)(vlSelf->top__DOT__Inst_Mem__DOT__w_state) 
                     << 1U) | (IData)(vlSelf->rst_n));
    if ((1U & Vtop__ConstPool__TABLE_hd966ed2d_0[__Vtableidx2])) {
        vlSelf->top__DOT__Inst_Mem__DOT__w_state = 
            Vtop__ConstPool__TABLE_hbabcb1ee_0[__Vtableidx2];
    }
    if ((2U & Vtop__ConstPool__TABLE_hd966ed2d_0[__Vtableidx2])) {
        vlSelf->top__DOT__useless2 = Vtop__ConstPool__TABLE_h39bac05e_0
            [__Vtableidx2];
    }
    vlSelf->top__DOT__useless3 = Vtop__ConstPool__TABLE_hf453b5e1_0
        [__Vtableidx2];
    if ((8U & Vtop__ConstPool__TABLE_hd966ed2d_0[__Vtableidx2])) {
        vlSelf->top__DOT__Inst_Mem__DOT__wdata = Vtop__ConstPool__TABLE_hf6a158b9_0
            [__Vtableidx2];
    }
    if ((0x10U & Vtop__ConstPool__TABLE_hd966ed2d_0
         [__Vtableidx2])) {
        vlSelf->top__DOT__Inst_Mem__DOT__wstrb = Vtop__ConstPool__TABLE_h3daa208e_0
            [__Vtableidx2];
    }
    if (vlSelf->rst_n) {
    ...
    if (vlSelf->rst_n) {
        ...
        if (((0U == (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state)) 
             & (IData)(vlSelf->top__DOT__lsu_wvalid))) {
            vlSelf->top__DOT__lsu_wready = 1U;
            vlSelf->__Vdly__top__DOT__Data_Mem__DOT__w_state = 1U;
        } else if ((1U == (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state))) {
            vlSelf->__Vdly__top__DOT__Data_Mem__DOT__w_state 
                = (3U & ((IData)(1U) + (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state)));
            vlSelf->top__DOT__lsu_wready = 0U;
        } else if ((2U == (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state))) {
            vlSelf->__Vdly__top__DOT__Data_Mem__DOT__w_state 
                = (3U & ((IData)(1U) + (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state)));
            vlSelf->top__DOT__lsu_wready = 0U;
        } else if ((3U == (IData)(vlSelf->top__DOT__Data_Mem__DOT__w_state))) {
        ...
        if ((0U == (IData)(vlSelf->top__DOT__LSU__DOT__current_state))) {
            ...
            vlSelf->top__DOT__lsu_arvalid = vlSelf->top__DOT__MemRead_exu_to_lsu;
    ...
    vlSelf->__Vtableidx7 = (((IData)(vlSelf->top__DOT__ready_wbu_to_ifu) 
    ...
    vlSelf->top__DOT__WBU__DOT__next_state = Vtop__ConstPool__TABLE_h1dd48d1a_0
        [vlSelf->__Vtableidx7];
    vlSelf->top__DOT__lsu_bvalid = vlSelf->rst_n;
    if (vlSelf->rst_n) {
    ...
    vlSelf->top__DOT__Data_Mem__DOT__araddr = vlSelf->__Vdly__top__DOT__Data_Mem__DOT__araddr;
    ...
    vlSelf->__Vtableidx3 = (((IData)(vlSelf->top__DOT__ready_idu_to_exu) 
    ...
    vlSelf->top__DOT__IDU__DOT__next_state = Vtop__ConstPool__TABLE_h1dd48d1a_0
        [vlSelf->__Vtableidx3];
    vlSelf->__Vtableidx6 = (((IData)(vlSelf->top__DOT__ready_exu_to_lsu) 
