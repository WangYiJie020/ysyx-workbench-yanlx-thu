    ...
    if (vlSelf->rst_n) {
        ...
        if ((0U == (IData)(vlSelf->top__DOT__LSU__DOT__current_state))) {
            ...
            __Vdlyvval__top__DOT__LSU__DOT__araddr_buffer__v63 
                = vlSelf->top__DOT__LSU__DOT__araddr;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__lsu_araddr = vlSelf->top__DOT__LSU__DOT__alu_result;
    vlSelf->top__DOT__Data_Mem__DOT__ar_state = vlSelf->__Vdly__top__DOT__Data_Mem__DOT__ar_state;
    vlSelf->top__DOT__lsu_arvalid = (1U & ((0x10U & (IData)(vlSelf->top__DOT__LSU__DOT__arvalid_delay))
                                            ? ((8U 
                                                & (IData)(vlSelf->top__DOT__LSU__DOT__arvalid_delay))
                                                ? (
                                                   (4U 
                                                    & (IData)(vlSelf->top__DOT__LSU__DOT__arvalid_delay))
                                                    ? 
