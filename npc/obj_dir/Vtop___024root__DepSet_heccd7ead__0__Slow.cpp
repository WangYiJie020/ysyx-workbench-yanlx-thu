...
VL_ATTR_COLD void Vtop___024root___eval_initial(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__Inst_Mem__DOT__awaddr 
        = vlSelf->top__DOT__Inst_Mem__DOT__awaddr;
    vlSelf->__Vtrigrprev__TOP__top__DOT__Inst_Mem__DOT__wdata 
        = vlSelf->top__DOT__Inst_Mem__DOT__wdata;
    vlSelf->__Vtrigrprev__TOP__top__DOT__Data_Mem__DOT__awaddr 
        = vlSelf->top__DOT__Data_Mem__DOT__awaddr;
    vlSelf->__Vtrigrprev__TOP__top__DOT__Data_Mem__DOT__wdata 
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] top.Inst_Mem.awaddr or [changed] top.Inst_Mem.wdata)\n");
    }
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] top.Data_Mem.awaddr or [changed] top.Data_Mem.wdata)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] top.Inst_Mem.awaddr or [changed] top.Inst_Mem.wdata)\n");
    }
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] top.Data_Mem.awaddr or [changed] top.Data_Mem.wdata)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__lsu_bresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__Inst_Mem__DOT__w_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__b_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__araddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Inst_Mem__DOT__awaddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Inst_Mem__DOT__wdata = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Inst_Mem__DOT__wstrb = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__Inst_Mem__DOT__wvalid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__flag_waddr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__flag_wdata = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__flag_rdata = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__flag_raddr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Inst_Mem__DOT__rdata_counter = VL_RAND_RESET_I(7);
    ...
    vlSelf->top__DOT__Data_Mem__DOT__w_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__b_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__araddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Data_Mem__DOT__awaddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Data_Mem__DOT__wdata = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__Data_Mem__DOT__wstrb = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__Data_Mem__DOT__wvalid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__flag_waddr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__flag_wdata = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__flag_rdata = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__flag_raddr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__Data_Mem__DOT__rdata_counter = VL_RAND_RESET_I(7);
    ...
    vlSelf->__Vdly__top__DOT__Data_Mem__DOT__flag_rdata = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__top__DOT__Data_Mem__DOT__rdata_counter = VL_RAND_RESET_I(7);
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__Inst_Mem__DOT__awaddr = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__top__DOT__Inst_Mem__DOT__wdata = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__top__DOT__Data_Mem__DOT__awaddr = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__top__DOT__Data_Mem__DOT__wdata = VL_RAND_RESET_I(32);
