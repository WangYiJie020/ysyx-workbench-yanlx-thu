...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__axi_rresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__uart_rresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__uart_bresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__sram_rresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__sram_bresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__clint_rresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__clint_bresp = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__Mem__DOT__wstrb = VL_RAND_RESET_I(8);
