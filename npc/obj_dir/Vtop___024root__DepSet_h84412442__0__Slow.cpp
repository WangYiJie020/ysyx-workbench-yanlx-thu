...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((0x100073U == vlSelf->top__DOT__inst))) {
        ...
        VL_FINISH_MT("/home/yanlx/ysyx-workbench/npc/vsrc/top.v", 155, "");
    }
    ...
    vlSelf->top__DOT__mem_read = Vtop__ConstPool__TABLE_h8bd5a248_0
        [vlSelf->__Vtableidx1];
    vlSelf->top__DOT__mem_write = Vtop__ConstPool__TABLE_h8bd5a248_0
        [vlSelf->__Vtableidx1];
    vlSelf->top__DOT____Vcellout__Controler__wmask 
        = Vtop__ConstPool__TABLE_h8bd5a248_0[vlSelf->__Vtableidx1];
    ...
    if (((IData)(vlSelf->top__DOT__mem_write) & (~ (IData)(vlSelf->top__DOT__mem_read)))) {
        Vtop___024unit____Vdpiimwrap_pmem_write_TOP____024unit(vlSelf->top__DOT__alu_result, 
                                                               ...
                                                               (0x1fU 
                                                                & (vlSelf->top__DOT__inst 
                                                                   >> 0x14U))], vlSelf->top__DOT____Vcellout__Controler__wmask);
    }
    Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__alu_result, vlSelf->__Vfunc_pmem_read__3__Vfuncout);
    vlSelf->top__DOT__Data_Mem__DOT__read_data__out__strong__out0 
        = (((~ (IData)(vlSelf->top__DOT__mem_write)) 
            & (IData)(vlSelf->top__DOT__mem_read)) ? vlSelf->__Vfunc_pmem_read__3__Vfuncout
            : 0U);
}
