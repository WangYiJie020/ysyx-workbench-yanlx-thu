...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__mode_register = VL_RAND_RESET_I(13);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 4194304; ++__Vi1) {
            vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__bank[__Vi0][__Vi1] = VL_RAND_RESET_I(16);
        }
    }
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__r_ba = VL_RAND_RESET_I(2);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__r_col_addr = VL_RAND_RESET_I(10);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__bank_addr = VL_RAND_RESET_I(22);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__r_bank_addr = VL_RAND_RESET_I(22);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__bank_active_raw[__Vi0] = VL_RAND_RESET_I(12);
    }
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__cas_cnt = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__bl_cnt = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__write_brust = VL_RAND_RESET_I(1);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__read_burst = VL_RAND_RESET_I(1);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT__dout = VL_RAND_RESET_I(16);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_high__DOT____VdfgTmp_h6089aaeb__0 = 0;
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__mode_register = VL_RAND_RESET_I(13);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 4194304; ++__Vi1) {
            vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__bank[__Vi0][__Vi1] = VL_RAND_RESET_I(16);
        }
    }
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__r_ba = VL_RAND_RESET_I(2);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__r_col_addr = VL_RAND_RESET_I(10);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__bank_addr = VL_RAND_RESET_I(22);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__r_bank_addr = VL_RAND_RESET_I(22);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__bank_active_raw[__Vi0] = VL_RAND_RESET_I(12);
    }
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__cas_cnt = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__bl_cnt = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__write_brust = VL_RAND_RESET_I(1);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__read_burst = VL_RAND_RESET_I(1);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT__dout = VL_RAND_RESET_I(16);
    vlSelf->ysyxSoCFull__DOT__sdram__DOT__u1_low__DOT____VdfgTmp_h6089aaeb__0 = 0;
